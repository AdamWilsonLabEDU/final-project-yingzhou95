...
### Clean the data
Warning: This step may take more than 3 days because the original twitter data is too big. If you want to do analysis in your computer, please load the cleaned data in the date file.
```{r}
# clean data
